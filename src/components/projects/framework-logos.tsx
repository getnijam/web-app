...
type LogoProps = { size?: number } & Omit<SVGProps<SVGSVGElement>, 'width' | 'height'>;

export function PlaywrightLogo({ size = 20, ...props }: LogoProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function PytestLogo({ size = 20, ...props }: LogoProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function VitestLogo({ size = 20, ...props }: LogoProps) {
  return (
    <svg
      width={size}
      height={size}
