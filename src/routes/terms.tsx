      ...
      <Section title="6. Plans, billing & payments">
        <Bullets
          items={[
            ...
            'Pro is $20/month and includes 10,000 test results per month and unlimited members, with 90-day retention. Usage beyond the included amount is billed at $0.002 per additional test result, calculated and invoiced in arrears at the end of each billing period.',
